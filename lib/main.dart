  ...
  void _showDownloadLocationDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          TextButton(
Bhai, maine pura code dobara check kiya. Ek chhoti si galti thi — settings.dart mein WebViewController use hua tha lekin webview_flutter import nahi tha. Ab maine woh theek kar diya hai.

Yeh raha bilkul sahi aur pura code, ek hi file mein:

📄 lib/main.dart (Final, Checked, Ek Hi File)
dart
import 'dart:async';
import 'package:flutter/material.dart';
import 'package:app_links/app_links.dart';
